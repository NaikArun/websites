          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="action.php?remove=<?= $row['id'] ?>" class="text-danger lead" onclick="return confirm('Are you sure want to remove this item?');"><i class="fas fa-trash-alt">remove</i></a>
                </td>
              </tr>

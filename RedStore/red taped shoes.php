...
<!--------single product details------->
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="images/red taped shoes 1.jpg" width="100%" id="productImg">
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="images/red taped shoes 1.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="images/red taped shoes 2.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="images/red taped shoes 3.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="images/red taped shoes 4.jpg" width="100%" class="small-img">
                    </div>
                </div>
            </div>
            <div class="col-2">
                <p>Home/ shoes</p>
                <h1>Red taped shoes</h1>
                <h4>Rs 550</h4>
                <select>
